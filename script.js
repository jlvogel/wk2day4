...
const BillsAndCoinsReturned = (amtPaid, amtCost) => {
  ...
  if (change.toFixed(2) != 0) {
    ...
    console.log(\`You receive $\${change.toFixed(2)} as change:\`)
      ...
      console.log(\`You receive no change.\`)
    }
  ...
  if(hundreds > 1) {
    console.log(\`\${hundreds} hundred dollar bills\`)
  } else if(hundreds > 0) {
    console.log(\`1 hundred dollar bill\`)
  }
  ...
  if(twenties > 1) {
    console.log(\`\${twenties} twenty dollar bills\`)
  } else if(twenties > 0) {
    console.log(\`1 twenty dollar bill\`)
  }
  ...
  if(tens > 1) {
    console.log(\`\${tens} ten dollar bills\`)
  } else if(tens > 0) {
    console.log(\`1 ten dollar bill\`)
  }
  ...
  if(fives > 1) {
    console.log(\`\${fives} five dollar bills\`)
  } else if(fives > 0) {
    console.log(\`1 five dollar bill\`)
  }
  ...
  if(ones > 1) {
    console.log(\`\${ones} one dollar bills\`)
  } else if(ones > 0) {
    console.log(\`1 one dollar bill\`)
  }
  ...
  let pennies = Math.round(coinAmount/0.01)
...
BillsAndCoinsReturned(300, 119.17)
BillsAndCoinsReturned(250, 201.01)
